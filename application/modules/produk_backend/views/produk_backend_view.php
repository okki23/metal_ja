f 
   ...
   <script type="text/javascript">
    ...
    $('#daftar_kategori').DataTable( {
        "ajax": "<?php echo base_url(); ?>produk_backend/fetch_cat_produk" 
    });
	 ...
	 function Show_Detail(id){ 
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>produk_backend/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
			 success:function(result){  
				 ...
				 $("#foto_dtl").attr("src","file_manager_dir/"+result.foto);
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('produk_backend/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
         ...
         var id_kategori = $("#id_kategori").val();
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>produk_backend/simpan_data",
             type:"POST",
             data:formData,
             contentType:false,  
             processData:false,   
	 ...
	 $('.datepicker').bootstrapMaterialDatePicker({
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable( {
			"ajax": "<?php echo base_url(); ?>produk_backend/fetch_produk_backend",
      'rowsGroup': [1] 
		});
	 
	    $('#daftar_sales').DataTable( {
            "ajax": "<?php echo base_url(); ?>produk_backend/fetch_kategori" 
        });
