   ...
   <script type="text/javascript">
	 ...
	 function Ubah_Data(id){
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>cat_produk/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('cat_produk/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
	     ...
	     var formData = new FormData($('#user_form')[0]); 
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>cat_produk/simpan_data",
             type:"POST",
             data:formData,
	 ...
	 $('.datepicker').bootstrapMaterialDatePicker({
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable( {
			"ajax": "<?php echo base_url(); ?>cat_produk/fetch_cat_produk" 
		});
